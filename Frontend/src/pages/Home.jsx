    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <div className="flex flex-col items-center justify-start pt-16 px-6">
        <div className="text-center mb-12">
          <h1 className="text-6xl sm:text-7xl font-bold font-serif text-gray-900 mb-6 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
            Phishing-site Detector
          </h1>
          <p className="text-2xl sm:text-3xl font-mono leading-relaxed text-gray-700 max-w-4xl mx-auto">
            Welcome to the ultimate phishing detector. Stay safe online.
          </p>
        </div>

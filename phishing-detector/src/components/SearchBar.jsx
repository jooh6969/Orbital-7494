    ...
    <div className="p-12 max-w-4xl mx-auto">
      ...
      >
        <input
          ...
          className="border border-gray-400 px-8 py-6 rounded text-[1rem] w-full shadow-md h-[60px]"
        />
        <button
          type="submit"
          className="bg-blue-600 text-white px-8 rounded hover:bg-blue-700 text-[1rem] font-semibold shadow-md h-[60px]"
        >
